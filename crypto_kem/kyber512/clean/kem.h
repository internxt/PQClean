...
int PQCLEAN_KYBER512_CLEAN_crypto_kem_enc_internal(uint8_t *ct, const uint8_t *ss, const uint8_t *pk);

int PQCLEAN_KYBER512_CLEAN_crypto_kem_dec_internal(uint8_t *ss, const uint8_t *ct, const uint8_t *sk);

int PQCLEAN_KYBER512_CLEAN_crypto_kem_keypair_seeded(uint8_t *pk, uint8_t *sk, const uint8_t *coins);
